...
public class Tuple {
  ...
  */
  public boolean isImpossible() { return this == IMPOSSIBLE; }
  ...
  */
  public int total() {
    int sum = 0;
    for (int i = 0; i < length(); i++) { sum += getElement( i ); }
    return sum;
  }
  ...
  */
  ...
  public boolean equals( Object t ) {
    ...
    for(int i = 0; i < length(); i++) {
      if ( getElement( i ) != ((Tuple)t).getElement( i ) ) { return false; }
    }
  ...
  */
  ...
  public int hashCode() {
    int product = 1;
    if ( this.isImpossible() ) { return 0; }
    for (int i = 0; i < length(); i++) { product *= getElement( i ); }
  ...
  */
  ...
  public String toString() {
    if ( isImpossible() ) { return "Impossible tuple"; }
